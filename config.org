...
- [[#beacon][Beacon]]
- [[#hideshow-mode-settings][HideShow Mode Settings]]
...
(use-package corfu
  ...
  (:map corfu-map
        ...
        ("TAB"     . corfu-next)               ;; TAB moves to next
        ([tab]     . corfu-next)               ;; TAB moves to next
        ("S-TAB"   . corfu-previous)           ;; Shift-TAB moves to previous
        ([backtab] . corfu-previous)           ;; Shift-TAB moves to previous
        ("RET"     . corfu-insert)             ;; ENTER selects/completes
        ([return]  . corfu-insert))            ;; ENTER selects/completes
  )
